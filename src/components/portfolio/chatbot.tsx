      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            data-cursor="link"
            className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-foreground text-[var(--cream)] shadow-xl hover:scale-105 transition-transform"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-5 right-5 z-50 flex h-[520px] w-[calc(100vw-2.5rem)] max-w-[380px] flex-col overflow-hidden rounded-2xl border border-[var(--rule)] bg-[var(--cream)] shadow-2xl"
          >
            {/* Header */}
